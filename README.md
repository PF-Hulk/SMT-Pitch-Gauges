...
### Purpose:
- Quickly determine and verify the correct mechanical feeder pitch for
  pick-and-place machines, reducing setup errors and operator learning curves.

### Contents:
- 3D model files containing gauge tools of varying pitch sizes 
  - e.g., 4mm, 8mm, 12mm, etc.
...
4. I recomended Protopasta's Static Dissipative PLA (PLA1170-ESD) filament. The technical datasheet show a tested max 10^8 Ω using a Desco 19786. I personally have validated this and is compliant with the strict ANSI/ESD S20.20-2021 standard.
